<template>
  <div  style="display:block;" >
    <div class="btn—group">
      <button v-if="config.showCheckBack=='1'" class="btn hvr-bounce-to-bottom" @click="checkAll">全 选</button>
    ...
    <div class="table" >
      <table>
        ...
        <tr v-for="(data,i) in config.dataset" :class="{'odd':i%2==0,'sin':i%2==1}">
          ...
          <td  v-if="config.actions.length>0"  class="actions">
